...
const MAX_FALL_SPEED : float = 3640 * Config.GAME_SPEED;
const GOAL_MIN_DISTANCE : Vector2 = Vector2(0, 1460);
const GOAL_MAX_DISTANCE : Vector2 = Vector2(150, 2600);
const MIN_HORIZONTAL_FLIP_EDGE : float = 0.79;
const MAX_HORIZONTAL_FLIP_EDGE : float = 1.0;
...
func init() -> void:
	base_sprite_scale = System.random.randf_range(MIN_BASE_SPRITE_SCALE, MAX_BASE_SPRITE_SCALE);
