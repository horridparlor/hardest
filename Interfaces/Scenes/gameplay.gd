...
const AnimationMinWaitTime : Dictionary = {
	GameplayEnums.AnimationType.INFINITE_VOID: 6.7 * Config.GAME_SPEED_MULTIPLIER,
...
const AnimationMaxWaitTime : Dictionary = {
	GameplayEnums.AnimationType.INFINITE_VOID: 6.9 * Config.GAME_SPEED_MULTIPLIER,
...
const INFINITE_VOID_BACKGROUND_MAX_OPACITY : float = 0.96;
