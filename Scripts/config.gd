...
const SHOWCASE_CARD_ID : int = 146 if DEV_MODE else 0;
...
const SPAWNED_CARD : int = 53 if DEV_MODE else 1;
...
const SEEDED_CARD : int = 0 if DEV_MODE else 0;
