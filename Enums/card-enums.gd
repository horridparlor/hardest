...
var KeywordHints : Dictionary = {
	...
	Keyword.CLONING : "Create a permanent copy of the rightmost card in your hand.",
	...
	Keyword.MULTIPLY : "Double this card's value for each SAME_TYPE played in a row.",
	...
	Keyword.PERFECT_CLONE : "Create a perfect copy of the rightmost card in your hand.",
