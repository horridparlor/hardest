...
const StampHints : Dictionary = {
	Stamp.BLUETOOTH : "If this card in hand is better, replaces the card on your field before results.",
...
const KeywordNames : Dictionary = {
	...
	Keyword.BURIED_ALIVE : "Buried Alive",
	...
	Keyword.FRESH_WATER : "Fresh Water",
	Keyword.GREED : "Greed",
	...
	Keyword.LICH_KING : "Lich King",
	Keyword.MAGNETISM : "Magnetism",
	Keyword.MULTI_SPY : "Multi-spy",
	Keyword.MULTIPLY : "Multiply",
	Keyword.MUSHY : "Mushy",
	Keyword.NEGATIVE : "Negative",
	Keyword.NINE_LIVES : "Nine Lives",
	Keyword.NOSTALGIA : "Nostalgia",
	...
	Keyword.SKIBIDI : "Skibidi",
	Keyword.SOUL_HUNTER : "Soul Hunter",
	Keyword.SOUL_ROBBER : "Soul Robber",
...
const TranslateKeyword : Dictionary = {
	...
	"buried-alive" : Keyword.BURIED_ALIVE,
	...
	"fresh-water" : Keyword.FRESH_WATER,
	"greed" : Keyword.GREED,
	...
	"skibidi" : Keyword.SKIBIDI,
	"soul-hunter" : Keyword.SOUL_HUNTER,
	"soul-robber" : Keyword.SOUL_ROBBER,
...
var KeywordHints : Dictionary = {
	...
	Keyword.BURIED_ALIVE : "Played face-down. Becomes a random card of the same type, gains the other keywords.",
	...
	Keyword.DIGITAL : "If this card in hand is better, replaces the card on your field before results.",
	...
	Keyword.FRESH_WATER : "Draw until you have 3 cards. [i](Wet your hand.)[/i]",
	...
	Keyword.LICH_KING : "Double multiplier for every 3 SAME_TYPES in your grave or purge.",
	Keyword.MAGNETISM : "Forces opponent to choose a scissor. [i](If defeats or destroys a scissor, permanently gains rust.)[/i]",
	...
	Keyword.NINE_LIVES : "After you lose with a Cooties card 9 times, you get this.",
	Keyword.NOSTALGIA : "Add 3 basic cards with pick-up to your hand.",
	...
	Keyword.PICKLED : "Double multiplier for each face-down card you have played this game.",
	Keyword.POSITIVE : "Double your points.",
	Keyword.RAINBOW : "Each card in opponent's hand becomes a random card of same type.",
	Keyword.RECYCLE : "If this card sent to your grave last turn is better, replaces the one on your field before results. [i](This card can also replace itself with the cards sent to your grave last turn.)[/i]",
	...
	Keyword.SHADOW_REPLACE : "If this card on top of your deck is better, replaces the one on your field before results. [i](This card can also replace itself with the top card of your deck.)[/i]",
	...
	Keyword.SKIBIDI : "Double multiplier for each card in your hand.",
	Keyword.SOUL_HUNTER : "You get the cards this defeats at the start of next game.",
	Keyword.SOUL_ROBBER : "Permanently steal the cards this defeats.",
